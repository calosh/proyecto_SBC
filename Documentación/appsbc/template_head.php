...
<!-- header -->
			<header>
				...
				<div class="wrapper">
					<div class="slider">
					  <ul class="items">
						<li><img src="images/artista3.png" alt=""></li>
						<li><img src="images/artista2.png" alt=""></li>
						<li><img src="images/artista1.png" alt=""></li>
					  </ul>
					</div>
				</div>
			</header><div class="ic">Mas información!</div>
